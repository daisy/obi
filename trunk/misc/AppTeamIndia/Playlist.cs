...
namespace Obi
{
    ...
    public class Playlist
    {
        ...
        private System.Windows.Forms.Timer MoniteringTimer = new System.Windows.Forms.Timer(); // Avneesh
        private bool CanPlay = false; // Avneesh
        ...
        public Playlist(Project project, AudioPlayer player)
        {
            ...
            MoniteringTimer.Tick += new System.EventHandler( MoniteringTimer_Tick ); // Avneesh
            MoniteringTimer.Interval = 200; // Avneesh
        ...
        public void Play()
        {
            if (mPhrases.Count > 0)
            {
                ...
                else if (mPlayer.State == AudioPlayerState.Stopped)
                {
                    ...
                    mPlayer.EndOfAudioAsset += new Events.Audio.Player.EndOfAudioAssetHandler(UpdateEndFlag ) ; // Avneesh
                    MoniteringTimer.Enabled = true; // Avneesh
        ...
        private void MoveToNextPhrase () // (object sender, Events.Audio.Player.EndOfAudioAssetEventArgs e) // Avneesh
        {
        ...
        public void Stop()
        {
            ...
            MoniteringTimer.Enabled = false; // Avneesh
        }
        ...
        void UpdateEndFlag(object sender, EventArgs e) // Avneesh
        {
            CanPlay = true ;
        }

        private void MoniteringTimer_Tick(object sender, EventArgs e) // Avneesh
        {
            if (CanPlay == true)
            {
