...
SelectionChangedPlaybackEnabled = false;
        ...
        public void InitializeTooltipsForTransportpar()
        {
            ...
            //mTransportBarTooltip.SetToolTip(mPlayButton, Localizer.Message("Transport_StartPlayback") + "(" + keyboardShortcuts.FormatKeyboardShorcut(keyboardShortcuts.MenuNameDictionary["mPlaySelectionToolStripMenuItem"].Value.ToString()) + ")");
            //mTransportBarTooltip.SetToolTip(mPauseButton, Localizer.Message("Transport_StartPlayback") + "(" + keyboardShortcuts.FormatKeyboardShorcut(keyboardShortcuts.MenuNameDictionary["mPauseToolStripMenuItem"].Value.ToString()) + ")");
           ...
           // mTransportBarTooltip.SetToolTip(m_btnRecordingOptions, Localizer.Message("Transport_RecordingOptions"));
            ...
            //mPlayButton.AccessibleName = Localizer.Message("Transport_StartPlaybackAcc") + "(" + keyboardShortcuts.FormatKeyboardShorcut(keyboardShortcuts.MenuNameDictionary["mPlaySelectionToolStripMenuItem"].Value.ToString()) + ")";
            //mPauseButton.AccessibleName = Localizer.Message("Transport_StartPausebackAcc") + "(" + keyboardShortcuts.FormatKeyboardShorcut(keyboardShortcuts.MenuNameDictionary["mPauseToolStripMenuItem"].Value.ToString()) + ")";
