...
// if recording phrase is not rooted, make it to null
        ...
        public bool NextPhrase()
        {
            if (CanNavigateNextPhrase)
            {
                ...
                {
                    if (mRecordingPhrase != null && mRecordingSession != null && mRecordingSession.AudioRecorder.TimeOfAsset < 250) return false;
        ...
        private void StopRecording()
        {
                ...
                mRecordingSession.AudioRecorder.State == Obi.Audio.AudioRecorderState.Recording))
            {
                ...
                try
                    ...
                    EmptyNode lastRecordedPhrase = mRecordingSection.PhraseChildCount >0? (PhraseNode)mRecordingSection.PhraseChild(mRecordingInitPhraseIndex + mRecordingSession.RecordedAudio.Count - 1):null;
