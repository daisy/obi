...
namespace Obi.ImportExport
{
    ...
    public class ImportStructureFromCSV 
    {
        ...
        private void ApplyPhraseDetectionOnPhrase(PhraseNode phraseNode, long threshold, double gap, double before)
        {
            ...
            phraseDetectionCommand = Commands.Node.SplitAudio.GetPhraseDetectionCommand(m_ProjectView, phraseNode, threshold, gap, before, m_ProjectView.ObiForm.Settings.Audio_MergeFirstTwoPhrasesAfterPhraseDetection,false,false,m_Presentation);
